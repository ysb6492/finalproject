...
<body>
    ...
    <div class="bottom-area">
        <div class="buttons">
            ...
            <button type="button" onclick="window.location.href='${pageContext.request.contextPath}/approve/mainapprove'">취소</button>
        </div>
    </div>
    <div class="container">
        ...
        <form id="expenseForm" method="post" enctype="multypart/form-data">
            ...
            <input type="hidden" id="docNo" name="docNo" value="${document.docNo}"> <!-- 추가 -->
            
            <table style="height:500px;">
                <tr class="form-group" style="height:25px;">
                    <th>제목</th>
                    <td colspan="7">
                    	<input type="text" class="input-text" id="doc-title" name="docTitle" value="${document.docTitle}">
                    </td>
                </tr>
                <tr class="form-group" style="height:25px;">
                    <th>작성일자</th>
                ...
                <tr style="height:25px;">
                    ...
                    <th>금액</th>
                    <td colspan="3">
                         <input type="text" class="input-text" id="totalField" name="totalExpense" readonly value="${expenseRequest[0].totalExpense}원"/>
                    </td>
                </tr>
                <tr>
                    <th>지출사유</th>
				    <td colspan="7">
				        <c:forEach var="expense" items="${expenseRequest}">
				            <textarea id="expenseReason-${expense.expenseNo}" name="expenseReason" style="width:100%; height:100%;">${expense.expenseReason}</textarea>
				        </c:forEach>
				    </td>
                </tr>
            </table>
            ...
            <table id="detailsTable">
                ...
                <tbody id="detailsBody">
                    <c:forEach var="expense" items="${expenseRequest}">
                        <tr>
                            <td><input type="date" class="input-text" name="expenseDate" value="${expense.expenseDate}" min="<%=today%>"></td>
                            <td>
                                <select class="input-text" name="expenseType">
                                	<option>선택하세요</option>
                                    <option value="물품구입비" ${expense.expenseType == '물품구입비' ? 'selected' : ''}>물품구입비</option>
                                    <option value="교통비" ${expense.expenseType == '교통비' ? 'selected' : ''}>교통비</option>
                                    <option value="식비" ${expense.expenseType == '식비' ? 'selected' : ''}>식비</option>
                                </select>
                            </td>
                            <td><input type="text" class="input-text" name="useInformation" value="${expense.useInformation}" placeholder="내용을 작성해주세요"></td>
                            <td><input type="text" class="input-text" name="expenseCost" value="${expense.expenseCost}"></td>
                            <td><input type="text" class="input-text" name="expenseEtc" value="${expense.expenseEtc}"></td>
                        </tr>
                    </c:forEach>
                </tbody>
            </table>
