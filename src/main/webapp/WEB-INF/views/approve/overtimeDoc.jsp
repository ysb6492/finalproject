        ...
        <form id="overtimeForm" method="post" action="${path}/approve/ajaxWriteOvertime">
            ...
            <table style="height:600px;">
            	<tr>
                    <th style="">*제목</th>
                    <td>
                       <input type="text" id="doc-title" class="input-text" name="docTitle" style="width:100%;">
                    </td>
                </tr>
                <tr>
                    <th style="">*근무구분</th>
                    <td>
                        <input type="radio" name="overtimeType" value="연장"> 연장
                        <input type="radio" name="overtimeType" value="야간"> 야간
                        <input type="radio" name="overtimeType" value="휴일"> 휴일
                    </td>
                </tr>
                <tr>
				    <th>*근무일시</th>
				    <td class="inline-input">
				        <input type="date" name="overtimeDate" class="input-text date-input">
				        <div class="time-input-container" style="margin-left:10px;">
				            <input type="text" name="startTimeHour" class="time-input" placeholder="hour" maxlength="2" oninput="formatTime(this)">시
				            <input type="text" name="startTimeMinute" class="time-input" placeholder="min" maxlength="2" oninput="formatTime(this)">분 ~
				            <input type="text" name="endTimeHour" class="time-input" placeholder="hour" maxlength="2" oninput="formatTime(this)">시
				            <input type="text" name="endTimeMinute" class="time-input" placeholder="min" maxlength="2" oninput="formatTime(this)">분
				        </div>
				    </td>
				</tr>
                <tr>
                ...
                <tr>
                    <th>*신청 사유</th>
                    <td>
                        <textarea name="overtimeReason" class="input-text" placeholder="내용을 기재해주세요"></textarea>
                    </td>
                </tr>
            </table>
            <input type="hidden" id="calculatedOvertime" name="calculatedOvertime">
